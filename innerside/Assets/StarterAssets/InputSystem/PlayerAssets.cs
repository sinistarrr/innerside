...
//     version 1.14.0
//     from Assets/StarterAssets/InputSystem/PlayerAssets.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/StarterAssets/InputSystem/PlayerAssets.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayerAssets : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Crouch"",
                    ""type"": ""Button"",
                    ""id"": ""29a0c0d0-57c1-4acf-bd38-192fb34a4ab1"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""e32c9b4b-c8ae-41ba-86b6-d61e4b0914f2"",
                    ""path"": ""<Keyboard>/c"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";KeyboardMouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""6d4a953c-47dc-4986-9a4b-aa2247ecd4a4"",
    ...
    ~@PlayerAssets()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, PlayerAssets.Player.Disable() has not been called.");
    }
